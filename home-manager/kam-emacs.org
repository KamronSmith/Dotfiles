...
(defun kam-task-new-project ()
  ...
  (let* ((default-directory kam-task-projects-directory)
    ...
    (project-remember-project new-project)
...
(defun kam-task-delete-project ()
  ...
  (interactive)
  (let* ((default-directory kam-task-projects-directory)
	(project-name (read-directory-name "Project to delete: "))
	(project (concat kam-task-projects-directory project-name)))
    (project-forget-project project)
    (delete-directory project t t)))
#+end_src
*** Areas
#+begin_src emacs-lisp :tangle (concat user-emacs-directory "lisp/kam-task.el")

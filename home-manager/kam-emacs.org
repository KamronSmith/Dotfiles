...
(setq font-log nil
      ...
      package-selected-packages '(jsonrpc transient consult org-roam))
#+end_src
...
<<<<<<< HEAD
(package-vc-install '(ultrascroll :vc-backend Git :url "https://github.com/jdtsmith/ultra-scroll"))
...
;;   :config
;;   (ultra-scroll-mode 1))
>>>>>>> cccfabd1f11888f25d494ab34ed34eb6b9d83b69
#+end_src
** =Repeat-mode=
:PROPERTIES:
